...
def getBillionUsersDay(growthRates):
  # Write your code here
  no_of_apps = len(growthRates)
  current_no_of_users = [1 for i in range(no_of_apps)]
  desired_total_no_of_users = 10 ** 9
  total_current_no_of_users = no_of_apps
  no_of_days = 0
  while total_current_no_of_users < desired_total_no_of_users:
    no_of_days += 1
    for i in range(no_of_apps):
      current_no_of_users[i] *= growthRates[i]
    total_current_no_of_users = array_sum(current_no_of_users)
  return no_of_days
