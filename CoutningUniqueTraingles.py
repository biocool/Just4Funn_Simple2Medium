...
def makeDictofTraingles(arr):
  dictofTraingles = dict()
  for current_traingle in arr:#triplet is like [a,b,c]
    current_traingle = tuple(sorted(current_traingle))#sorted converts tuple to list and list in not hashable. So, we nned to convert that into a tuple again.    
    if current_traingle in dictofTraingles:
      dictofTraingles[current_traingle] += 1
    else:
      dictofTraingles[current_traingle] = 1
  return dictofTraingles
      
    

def countDistinctTriangles(arr):
  # Write your code here
  dictofTraingles = makeDictofTraingles(arr)
  return(len(dictofTraingles.keys()))
...
if __name__ == "__main__":
  ...
  arr_3 = [(3, 4, 5), (8, 8, 9), (7, 7, 7), (7, 8, 7), (7, 7, 7), (8, 7, 7)]
  expected_3 = 4
